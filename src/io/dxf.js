...
function writeZoneSymbol(w, rect, kind) {
  ...
  if (kind === 'door') {
    ...
    const { axis, dir } = resolveStairOrient(rect, b.x0, b.x1, b.y0, b.y1);
    const { treads, arrow } = stairSegments(width, height, axis, dir, kind === 'stairs_up');
    segs('STAIRS', [...treads, ...arrow]);
